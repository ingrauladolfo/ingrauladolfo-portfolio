...
export const pathToTitle: PathToTitle[] = [
  ...
  { path: { en: '/experience', es: '/experiencia' }, title: { en: "Experience | Portfolio of I.S.C. Raúl Adolfo Torres Vargas | Web Developer and Programmer with over 5 years of experience", es: "Experiencia | Porfolio de I.S.C. Raúl Adolfo Torres Vargas | Desarrollador y Programador Web con más de 5 años de Experiencia", } },
