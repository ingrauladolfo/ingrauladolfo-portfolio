    ...
    <section className='py-1 w-full mx-auto lg:w-[740px] pb-32'>
      <div className="max-w-svh">
        ...
        <p className="mt-4 text-xl text-gray-800 dark:[&>strong]:text-yellow-200 [&>strong]:text-yellow-500 [&>strong]:font-semibold dark:text-gray-300">
          +5 años de experiencia. <strong>Desarrollador de Software y fundador de ESDMX</strong> originario de Lázaro Cárdenas Michoacán, México. Especializado en el desarrollo          de aplicaciones web únicas con JavaScript como Frontend.
        </p>
      </div>
    </section>
  );
